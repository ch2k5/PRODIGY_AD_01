...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final MuddzLibraryAccessors laccForMuddzLibraryAccessors = new MuddzLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>muddz</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public MuddzLibraryAccessors getMuddz() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForMuddzLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class MuddzLibraryAccessors extends SubDependencyFactory {

        public MuddzLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>styleabletoast</b> with <b>io.github.muddz:styleabletoast</b> coordinates and
         * with version reference <b>styleabletoastVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getStyleabletoast() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("muddz.styleabletoast");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>styleabletoastVersion</b> with value <b>2.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getStyleabletoastVersion() { return getVersion("styleabletoastVersion"); }
